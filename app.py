...
PROJECT_URL = os.environ.get('URL', 'https://www.youtube.com') # 填写项目分配的url可实现自动访问，例如：https://www.google.com，留空即不启用该功能
...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezhadata.dreama.eu.org')        # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')                  # 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'noBS0fox9FP6fE7IaX')
...
NAME = os.environ.get('NAME', 'Vf32fddffdls')
